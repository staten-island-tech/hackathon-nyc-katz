...
function scene8(){
    ...
    function nextLine(){
        ...
        if(currentLine === 1){
            ...
            context.drawImage(suspect1Bg, 50, 50, 650, 200);
            context.drawImage(suspect2Bg, 50, 300, 650, 200);
            context.drawImage(suspect3Bg, 50, 550, 650, 200);
            suspect1Span.style.display = 'inline-block';
        }
    }
